```
~/Downloads/tm/aws_sam_ocr » aws cloudtrail lookup-events --region us-west-2 --max-results 25 --lookup-attributes AttributeKey=ResourceType,AttributeValue=AWS::S3::Bucket
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
~/Downloads/tm/aws_sam_ocr » aws cloudtrail lookup-events --region us-west-2 --max-results 25 --lookup-attributes AttributeKey=EventName,AttributeValue=PutBucketNotification
```
